...
public class PointsEndpointManager {
	...
	private String uddiURL = "http://user:pass@uddi.sd.rnl.tecnico.ulisboa.pt:9090/";
	/** Web Service name */
	private String wsName = "uddi";
	...
	private String wsURL = "http://dei.ist.utl.pt/ws/info";

	/** Port implementation */
	private PointsPortImpl portImpl = new PointsPortImpl(this);

	/** Obtain Port implementation */
	public PointsPortImpl getPort() {
		return portImpl;
	}
